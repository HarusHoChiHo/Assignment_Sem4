...
namespace MLModel_ChiHoHo_Assignment5
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\harusho\Centennial\COMP212\Assignment5\MLModel_ChiHoHo_Assignment5\insurance.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"sex", @"sex"),new InputOutputColumnPair(@"smoker", @"smoker"),new InputOutputColumnPair(@"region", @"region")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=235,NumberOfLeaves=10,FeatureFraction=1F,LabelColumnName=@"charges",FeatureColumnName=@"Features"}));
